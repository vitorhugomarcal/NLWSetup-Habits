...
CREATE TABLE "habit_week_days" (
    ...
    CONSTRAINT "habit_week_days_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "days" (
    ...
    "userId" TEXT NOT NULL,
    CONSTRAINT "days_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "day_habits" (
    ...
    CONSTRAINT "day_habits_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
